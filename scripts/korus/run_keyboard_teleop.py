...
$ cd ~/IsaacLab
$ python scripts/korus/korusbed_keyboard_teleop_multiple.py
...
class Params:
    ...
    initial: float = 0.0      # seed value if a joint hasn't been touched yet
...
def main():
    ...
    parser.add_argument("--max", dest="max_pos", type=float, default=0.9)

...
HUMANOID_CFG = ArticulationCfg(
    ...
    spawn=sim_utils.UsdFileCfg(usd_path=CFG.humanoid_usd, scale=(4.4, 4.4, 4.4)),
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0, 1.5, 2.5),
        rot=(1, 0, 0, 0),
        joint_pos={".*": 0.0},
...
KORUSFOAM_CFG: DeformableObjectCfg = DeformableObjectCfg(
